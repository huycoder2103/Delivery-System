...
public class AdminController extends HttpServlet {
        ...
        try {
            ...
            if (request.getParameter("ToggleUser") != null) {
                ...
                if (newPass == null || newPass.trim().isEmpty()) {
                    ...
                    if (ok) {
                        request.setAttribute("SUCCESS_MESSAGE", "Đổi mật khẩu thành công cho: " + uid);
                    } else {
                        request.setAttribute("ERROR_MESSAGE", "Đổi mật khẩu thất bại!");
                    }
                }
    ...
    private List<String[]> getAllAnnouncements() {
        ...
        try (Connection c = DBUtils.getConnection();
            ...
            log("getAllAnnouncements error: " + e);
        }
        return list;
    }
    ...
    private void insertAnnouncement(String title, String content, String staffID) {
        ...
        try (Connection c = DBUtils.getConnection();
            ...
            log("insertAnnouncement error: " + e);
        }
    }
    ...
    private void deleteAnnouncement(String annID) {
        ...
        try (Connection c = DBUtils.getConnection();
            ...
            log("deleteAnnouncement error: " + e);
        }
    }
